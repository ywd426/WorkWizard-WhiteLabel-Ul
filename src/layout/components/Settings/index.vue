<template>
  <el-drawer v-model="showSettings" :with-header="false" direction="rtl" size="300px" close-on-click-modal>
    <h3 class="drawer-title">{{ $t('layoutSetting.themeStyleSetting') }}</h3>
    ...
    <div class="drawer-item">
      <span>{{ $t('layoutSetting.themeColor') }}</span>
      <span class="comp-style">
        <el-color-picker v-model="theme" :predefine="predefineColors" @change="themeChange" />
      </span>
    </div>
    <div class="drawer-item">
      <span>{{ $t('layoutSetting.darkMode') }}</span>
      <span class="comp-style">
    ...
    <h3 class="drawer-title">{{ $t('layoutSetting.systemLayoutConfiguration') }}</h3>

    <div class="drawer-item">
      <span>{{ $t('layoutSetting.openTopNav') }}</span>
      <span class="comp-style">
    ...
    <div class="drawer-item">
      <span>{{ $t('layoutSetting.openTagsViews') }}</span>
      <span class="comp-style">
    ...
    <div class="drawer-item">
      <span>{{ $t('layoutSetting.fixedHeader') }}</span>
      <span class="comp-style">
    ...
    <div class="drawer-item">
      <span>{{ $t('layoutSetting.showLogo') }}</span>
      <span class="comp-style">
    ...
    <div class="drawer-item">
      <span>{{ $t('layoutSetting.dynamicTitle') }}</span>
      <span class="comp-style">
    ...
    <el-button type="primary" plain icon="DocumentAdd" @click="saveSetting">{{ $t('layoutSetting.saveConfiguration') }}</el-button>
    <el-button plain icon="Refresh" @click="resetSetting">{{ $t('layoutSetting.resetConfiguration') }}</el-button>
  </el-drawer>
</template>
...
const saveSetting = () => {
  proxy?.$modal.loading('Saving Locally, Please Wait...');
